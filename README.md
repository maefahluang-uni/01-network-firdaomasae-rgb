[![Open in Codespaces](https://classroom.github.com/assets/launch-codespace-2972f46106e565e64193e422d61a12cf1da4916b45550586e14ef0a7c637dd04.svg)](https://classroom.github.com/open-in-codespaces?assignment_repo_id=20028355)
...
```
 The main() method starts two web servers on ports 8080 and 8081 in separate threads, waits for any key press, and then attempts to stop both servers and exit the program.
```
...
```
  - By passing a different port number to the MockWebServer constructor.
- By creating and starting more threads with different port numbers.
- By editing the HTML content in the server's response 
- To simulate multiple servers, test load balancing, or mock microservices in testing environments.
```
